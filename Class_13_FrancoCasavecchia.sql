...
#delete from film where title = 'ACADEMY DINOSAUR' # delete from film where title = 'ACADEMY DINOSAUR' 1 row(s) affected	0.031 sec
 
#Pero la manera correcta para borrar una film es de la siguiente manera,borrando todas las fk desde la clase padre a la hija

delete from payment 
where payment_id = 9917 and payment_id = 7340;

delete from rental
where inventory_id = 9 and 10 and 11;
